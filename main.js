document.addEventListener('DOMContentLoaded', () => {
    ...
    */
    ...
    function comprarCarrito() {
        // Realiza la animación de compra (puedes agregar una función para animar aquí)
    animacionCompra();
    
        // Aquí puedes agregar la lógica para procesar la compra, enviar una solicitud al servidor, etc.
    
        // Después de la compra, puedes vaciar el carrito si es necesario
    vaciarCarrito();
    ...
    // Agrega aquí tu lógica de animación, por ejemplo, cambiar colores, agregar clases, etc.
        // Puedes usar bibliotecas como jQuery o CSS para realizar animaciones.
